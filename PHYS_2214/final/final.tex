\documentclass{hw} \title{PHYS 2214 -- Final} \author{community}

\usepackage{code} \usepackage{pgf} \usepackage{tikz}
...
Magnetic Field Components): \begin{equation} \cbox{% u(t)  =
...
Since we know that \begin{equation} \cbox{% B(t) = \frac{E(t)}{c} =
...
\begin{equation} \cbox{% \vec{S}(t) = \frac{1}{\mu_0} \vec{E}(t) \times
...
position and time, we can show that: \begin{equation} \cbox{% Intensity =
